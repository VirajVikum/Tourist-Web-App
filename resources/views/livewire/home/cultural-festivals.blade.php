    ...
    <section class="py-16 bg-gradient-to-b from-white via-blue-100 to-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <h2 class="text-4xl md:text-4xl font-bold text-blue-700">
            ...
            <div class="relative">
                            ...
                            <div class="relative h-72 overflow-hidden">
                                ...
                                <div class="absolute bottom-4 left-0 right-0 flex justify-center space-x-2">
                                    <template x-for="(dot, i) in total" :key="i">
                                        <div :class="{'bg-blue-700': current === i, 'bg-white/60': current !== i}"
                ...
                <div
                    class="absolute right-0 top-1/2 -translate-y-1/2 hidden md:flex items-center bg-blue-600 text-white px-4 py-2 rounded-l-full shadow-lg animate-pulse">
                    <span>→ Swipe</span>
                </div>
            </div>
        </div>
