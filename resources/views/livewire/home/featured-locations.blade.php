...
<section class="py-20 bg-gradient-to-b from-white via-blue-100 to-white relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mb-16 relative">
            <h2 class="text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-blue-700 to-blue-400 bg-clip-text text-transparent">
                Explore Your Destination in Paradise
            </h2>
                    ...
                    <a href="{{ route('place.details', $location['slug']) }}" wire:navigate>
                        <div class="group relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 cursor-pointer
                            ...
                            <div class="p-6 flex flex-col flex-grow"> <!-- flex-grow to fill space -->
                                <h4 class="text-xl font-bold text-blue-700 group-hover:text-blue-600 mb-2  line-clamp-2">
                                    {{ $location['name'] }}
                                </h4>
                                ...
                                <div class="mt-auto inline-flex items-center text-blue-600 font-semibold hover:text-blue-700 transition">
                                    Explore
                            ...
                            <!-- Glow hover effect -->
                            <div class="absolute inset-0 bg-gradient-to-r from-blue-400 to-cyan-400 opacity-0 group-hover:opacity-10 transition-opacity duration-500 rounded-3xl pointer-events-none"></div>
                        </div>
                    </a>
                </div>
            @endforeach
