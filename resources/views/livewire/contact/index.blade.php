<div class="bg-gradient-to-br from-orange-100 via-white to-yellow-100">
    ...
    <!-- Mobile: vertical stack | Desktop: your original grid -->
    <div class="flex flex-col md:flex-row md:min-h-screen">

        <!-- ===== CONTACT INFO (mobile: top, desktop: left) ===== -->
        <div class="flex flex-col justify-center p-8 space-y-6 md:pl-20 md:w-1/3 order-1 md:order-none">
            ...
            <div class="flex items-center gap-4 bg-white/80 backdrop-blur-lg p-4 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-1">
                <svg class="w-6 h-6 text-orange-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="flex items-center gap-4 bg-white/80 backdrop-blur-lg p-4 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-1">
                <svg class="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor">
            ...
            <div class="flex items-center gap-4 bg-white/80 backdrop-blur-lg p-4 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-1">
                <svg class="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor">
        ...
        <div class="flex items-center justify-center px-4 py-8 md:w-2/3 order-2 md:order-none">
            <div class="bg-white/70 backdrop-blur-lg shadow-2xl rounded-3xl p-10 w-full md:w-3/4 border border-white/50">
